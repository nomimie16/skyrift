...
def run_settings(screen, background, from_game):
    ...
    toggle_size = (80, 70)
    img_music_toggle_off = pygame.image.load("src/assets/img/off_song_toggle.png").convert_alpha()
    ...
    img_music_toggle_on = pygame.image.load("src/assets/img/on_song_toggle.png").convert_alpha()
    ...
    # === IMAGES TOGGLE SON ===
    img_sound_toggle_off = pygame.image.load("src/assets/img/off_song_toggle.png").convert_alpha()
    ...
    img_sound_toggle_on = pygame.image.load("src/assets/img/on_song_toggle.png").convert_alpha()
