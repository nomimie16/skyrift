...
* Toutes les unités présentées dans la boutique disposent de quatre statistiques déterminant leurs capacités : 

    * **HP** - Les points de vie. Plus ils sont élevés, plus l'unité pourra encaisser de dégats.
    * **ATK** - Les dégats d'attaques. Plus ils sont élevés, plus l'unité inflige de dégats par attaque.
